...
internal val MISSING_ANDROID_GRADLE_PLUGIN = message {
	english { "Please add id(\"com.android.application\") or id(\"com.android.library\") to build.gradle.kts" }
	chinese { "请在 build.gradle.kts 中添加 id(\"com.android.application\") 或 id(\"com.android.library\")" }
}
